...
public class CVPLocationProperties extends BaseApiBean {
  ...
  public static class CVPLocationPropertiesList extends BaseApiListBean<CVPLocationProperties> {
    @XmlElementWrapper(name = "CVPs")
    @XmlElement(name = "CVP")
    public List<CVPLocationProperties> getItems() {
      return items;
    }

    public void setItems(List<CVPLocationProperties> items) {
      this.items = items;
    }
  }
}
