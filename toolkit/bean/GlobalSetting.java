...
public class GlobalSetting extends BaseApiBean {
  ...
  @XmlElementWrapper(name="datacenterSettings")
  @XmlElement(name="datacenterSetting")
  public List<DataCenterSetting> getDataCenterSettingList() {
     return this.dataCenterSettingList;
  }
