...
public class DemoUtils {
    ...
    public static final int PCCE_2K = 7;
    public static final int PCCE_LAB = 10;
    public static final int PCCE_4K = 17;
    public static final int PCCE_12K = 18;
     ...
     * @param restClient
     */
    public static void checkPCCEDeploymentType(RESTClient restClient) {
        ...
        boolean isPCCE = isPCCEDeploymentType(deploymentType);

        if(!isPCCE){
            System.out.println("AgentSkillGroupDemo can only be run in PCCE deployments.");
            System.exit(0);
        }
    }
     ...
     * @return true if deployment type is PCCE
     */
    public static boolean isPCCEDeploymentType(Deployment deploymentType) {
        return deploymentType.getDeploymentType() == PCCE_2K || deploymentType.getDeploymentType() == PCCE_LAB
                    || deploymentType.getDeploymentType() == PCCE_4K || deploymentType.getDeploymentType() == PCCE_12K;
    }
