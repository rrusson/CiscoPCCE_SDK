...
public class Registry extends BaseApiBean {
  ...
  public Integer getAppGwEnabled() {
     return this.appGwEnabled;
  }

  public void setAppGwEnabled(Integer appGwEnabled) {
  ...
  public Integer getHdsType() {
     return this.hdsType;
  }

  public void setHdsType(Integer hdsType) {
  ...
  public void setOutboundEnabled(Integer outboundEnabled) {
     this.outboundEnabled = outboundEnabled;
  }

  @XmlElementWrapper(name="peripheralGatewaysRegistries")
  @XmlElement(name="peripheralGatewaysRegistry")
  public List<PeripheralGatewaysRegistry> getPeripheralGatewaysRegistries() {
     return this.peripheralGatewaysRegistries;
  }
