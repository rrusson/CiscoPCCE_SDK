...
public class SmartLicenseServerList extends BaseApiBean {
  ...
  @Path("smartlicense")
  @XmlRootElement(name = "results")
  public static class SmartLicenseServerListList extends BaseApiListBean<SmartLicenseServerList> {
    @XmlElementWrapper(name = "resultss")
    @XmlElement(name = "results")
    public List<SmartLicenseServerList> getItems() {
      return items;
    }

    public void setItems(List<SmartLicenseServerList> items) {
      this.items = items;
    }
  }
}
